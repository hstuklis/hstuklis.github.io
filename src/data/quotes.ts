...
export const quotes: Quote[] = [
  ...
  {
    text: "All language is based on meat.",
  ...
  {
    text: "We believe that we invent symbols. The truth is that they invent us.",
    reference: "Autarch Severian the Lame"
  },
  {
  ...
  {
    text: "The best offense is a good defense, but a bad defense is offensive.",
    reference: "Autarch Severian the Lame"
  },
  {
    text: "\"I see,\" said Silk, though he did not, in either sense.",
    reference: "Patera Silk"
  },
  {
    text: "No cut!",
    reference: "Oreb 🐦"
